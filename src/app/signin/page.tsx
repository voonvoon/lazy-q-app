  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        //router.push("/dashboard/admin"); // Navigate to admin dashboard
        // Wait for session to update
        setTimeout(async () => {
        const updatedSession = await getSession(); // fetch latest session cuz only useSession() doesn't update immediately
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full ">
        <h2 className="mt-6 mb-1 text-center text-3xl font-extrabold text-gray-900">
        ...
        <div className="mt-6 p-4 bg-gray-100 rounded-md">
          <p className="text-sm text-gray-600">
            <strong>Test Super_admin Account:</strong>
            <br />
