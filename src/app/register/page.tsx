...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    // Zod validation
    const result = schema.safeParse(formData);//true and data if passes else false and error
    if (!result.success) {
      const errors: { name?: string; email?: string; password?: string } = {};
      //loop through all errors and assign the error messages to the correct field.
